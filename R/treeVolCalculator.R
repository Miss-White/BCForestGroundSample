...
setGeneric("treeVolCalculator",
           function(FIZorBEC, species, height, DBH, taperEquationForm, volMultiplier,
                    stumpHeight, breastHeight, UTOPDIB, BTOPEstimateType, BTOPHeight, BTOPDIB, 
                    logLengthMatrix, logMinLength){
             standardGeneric("treeVolCalculator")
           })
...
setMethod(
  "treeVolCalculator",
  signature = c(FIZorBEC = "character",
                species = "character", 
                height = "numeric",
                DBH = "numeric", 
                taperEquationForm = "character", 
                volMultiplier = "numeric",
                stumpHeight = "numeric",
                breastHeight = "numeric",
                UTOPDIB = "numeric",
                BTOPEstimateType = "integer",
                BTOPHeight = "numeric",
                BTOPDIB = "numeric", 
                logLengthMatrix = "data.table",
                logMinLength = "numeric"),
  definition = function(FIZorBEC, species, height, DBH, taperEquationForm, volMultiplier,
                        stumpHeight, breastHeight, UTOPDIB, BTOPEstimateType, BTOPHeight, BTOPDIB, 
                        logLengthMatrix, logMinLength){
...
setMethod(
  ...
  signature = c(FIZorBEC = "character",
                ...
                logLengthMatrix = "data.table",
                logMinLength = "numeric"),
  definition = function(FIZorBEC, species, height, DBH, volMultiplier,
                        BTOPEstimateType, BTOPHeight, BTOPDIB, 
                        logLengthMatrix, logMinLength){
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC",
                             volMultiplier, stumpHeight = 0.3, breastHeight = 1.3,
                             UTOPDIB = 10, BTOPEstimateType, BTOPHeight, BTOPDIB, 
                             logLengthMatrix, logMinLength))
  })
...
setMethod(
  ...
  signature = c(FIZorBEC = "character",
                ...
                logLengthMatrix = "data.table",
                logMinLength = "numeric"),
  definition = function(FIZorBEC, species, height, DBH, 
                        BTOPEstimateType, BTOPHeight, BTOPDIB, 
                        logLengthMatrix, logMinLength){
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC",
...
setMethod(
  ...
  definition = function(FIZorBEC, species, height, DBH, 
    ...
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC",
                             volMultiplier = 1, stumpHeight = 0.3, breastHeight = 1.3,
                             UTOPDIB = 10, BTOPEstimateType, BTOPHeight, BTOPDIB, 
                             logLengthMatrix = data.table(a = numeric()), logMinLength))
  })
...
setMethod(
  ...
  definition = function(FIZorBEC, species, height, DBH, 
                        logLengthMatrix, logMinLength){
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC", volMultiplier = 1,
                             stumpHeight = 0.3, breastHeight = 1.3, UTOPDIB = 10, BTOPEstimateType = as.integer(NA),
                             BTOPHeight = as.numeric(NA), BTOPDIB = as.numeric(NA), logLengthMatrix, logMinLength))
  })
...
setMethod(
  ...
  definition = function(FIZorBEC, species, height, DBH, 
    ...
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC", volMultiplier = 1,
                             stumpHeight = 0.3, breastHeight = 1.3, UTOPDIB = 10, BTOPEstimateType = as.integer(NA),
                             BTOPHeight = as.numeric(NA), BTOPDIB = as.numeric(NA), 
                             logLengthMatrix = data.table(a = numeric()), logMinLength))
  })
...
setMethod(
  ...
  definition = function(FIZorBEC, species, height, DBH){
    return(treeVolCalculator(FIZorBEC, species, height, DBH, taperEquationForm = "KBEC", volMultiplier = 1,
                             stumpHeight = 0.3, breastHeight = 1.3, UTOPDIB = 10, BTOPEstimateType = as.integer(NA),
                             BTOPHeight = as.numeric(NA), BTOPDIB = as.numeric(NA), 
                             logLengthMatrix = data.table(a = numeric()), logMinLength = 3))
  })
