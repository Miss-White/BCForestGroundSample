...
#' @author Yong Luo
#'
setGeneric("ageByForester",
           function(projectID, sampleNumber, sampleTypeCode) {
             standardGeneric("ageByForester")
           })
...
setMethod(
  ...
  signature = c(projectID = "character",
                sampleNumber = "character",
                sampleTypeCode = "character"),
  definition = function(projectID, sampleNumber, sampleTypeCode){
