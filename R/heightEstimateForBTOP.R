...
#' @author Yong Luo
#'
setGeneric("heightEstimateForBTOP_H",
           function(heightProjected) {
             standardGeneric("heightEstimateForBTOP_H")
           })

#' @rdname heightEstimateForBTOP_H
setMethod(
  "heightEstimateForBTOP_H",
  signature = c(heightProjected = "numeric"),
  definition = function(heightProjected){
...
#' @author Yong Luo
#'
setGeneric("heightEstimateForBTOP_D",
           function(heightBTOP, DIBBTOP, DBH,
                    taperEquationForm, FIZorBEC,
                    species, volMultiplier,
                    SASOriginal) {
             standardGeneric("heightEstimateForBTOP_D")
           })

#' @rdname heightEstimateForBTOP_D
setMethod(
  "heightEstimateForBTOP_D",
  signature = c(heightBTOP = "numeric",
                DIBBTOP = "numeric",
                DBH = "numeric", 
                ...
                SASOriginal = "logical"),
  definition = function(heightBTOP, DIBBTOP, DBH,
                        taperEquationForm, FIZorBEC,
                        species, volMultiplier,
                        SASOriginal){
...
setMethod(
  ...
  signature = c(heightBTOP = "numeric",
                ...
                SASOriginal = "logical"),
  definition = function(heightBTOP, DIBBTOP, DBH,
                        FIZorBEC, species, volMultiplier,
                        SASOriginal){
    return(heightEstimateForBTOP_D(heightBTOP, DIBBTOP, DBH,
                                   taperEquationForm = "KBEC", 
                                   FIZorBEC, species, volMultiplier, SASOriginal))
  })
...
setMethod(
  ...
  signature = c(heightBTOP = "numeric",
                ...
                SASOriginal = "logical"),
  definition = function(heightBTOP, DIBBTOP, DBH, taperEquationForm,
                        FIZorBEC, species, SASOriginal){
    return(heightEstimateForBTOP_D(heightBTOP, DIBBTOP, DBH,
                                   taperEquationForm, 
                                   FIZorBEC, species, volMultiplier = 1, SASOriginal))
  })
...
setMethod(
  ...
  definition = function(heightBTOP, DIBBTOP, DBH, taperEquationForm,
    ...
    return(heightEstimateForBTOP_D(heightBTOP, DIBBTOP, DBH,
                                   taperEquationForm, 
                                   FIZorBEC, species, volMultiplier, SASOriginal = FALSE))
  })
...
setMethod(
  ...
  definition = function(heightBTOP, DIBBTOP, DBH, 
    ...
    return(heightEstimateForBTOP_D(heightBTOP, DIBBTOP, DBH,
                                   taperEquationForm = "KBEC", 
                                   FIZorBEC, species, volMultiplier = 1,
                                   SASOriginal))
  })
